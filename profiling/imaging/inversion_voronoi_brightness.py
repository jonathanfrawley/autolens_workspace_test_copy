...
lens_hyper_image = lens_galaxy.image_from_grid(grid=masked_imaging.grid).slim_binned
source_hyper_image = source_galaxy.image_from_grid(grid=masked_imaging.grid).slim_binned
