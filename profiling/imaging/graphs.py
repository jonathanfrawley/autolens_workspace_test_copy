...
"""
profiling_path = os.path.join("profiling", "times", al.__version__, "inversion_voronoi_magnification")
...
graph_path = os.path.join(
    "profiling", "graphs", al.__version__, "inversion_voronoi_magnification"
)
...
def bar_deflection_profiles(
    ...
    [barlist[index].set_color("g") for index in range(6, 10)]
