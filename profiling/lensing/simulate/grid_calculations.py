...
grid = al.Grid2D.uniform(shape_native=shape_native, pixel_scales=0.05, sub_size=16)
...
print("Time to Compute Profile Image Using regular Grid2D = {}".format(diff))
...
tracer.image_from_grid(grid=grid)
diff = time.time() - start
print("Time to Compute Profile Image Using Grid2DIterate = {}".format(diff))
