...
"""
path_prefix = path.join("imaging", "slam", "mass_total__source_inversion", "stochastic")
...
"""
analysis = al.AnalysisImaging(dataset=masked_imaging, results=source_inversion_results)
