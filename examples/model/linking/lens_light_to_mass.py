...
The `name` and `path_prefix` below specify the path where results are stored in the output folder:  
 ...
 `/autolens_workspace/output/examples/linking/lens_light_to_mass/light_sersic__mass_sie__source_sersic/phase[1]`.
"""
...
The `name` and `path_prefix` below specify the path where results are stored in the output folder:  
 ...
 `/autolens_workspace/output/examples/linking/lens_light_to_mass/light_sersic__mass_sie__source_sersic/phase[2]`.
