...
export SCRIPTS_PATH=$WORKSPACE_PATH/scripts/imaging/advanced/pipelines/hyper
export NOTEBOOKS_PATH=$WORKSPACE_PATH/notebooks/imaging/advanced/pipelines/hyper
