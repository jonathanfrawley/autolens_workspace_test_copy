...
export SCRIPTS_PATH=$WORKSPACE_PATH/scripts/imaging/advanced/pipelines/with_lens_light
export NOTEBOOKS_PATH=$WORKSPACE_PATH/notebooks/imaging/advanced/pipelines/with_lens_light
