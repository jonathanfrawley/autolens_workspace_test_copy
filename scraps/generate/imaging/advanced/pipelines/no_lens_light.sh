...
export SCRIPTS_PATH=$WORKSPACE_PATH/scripts/imaging/advanced/pipelines/no_lens_light
export NOTEBOOKS_PATH=$WORKSPACE_PATH/notebooks/imaging/advanced/pipelines/no_lens_light
