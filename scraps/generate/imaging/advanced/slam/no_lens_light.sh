...
export SCRIPTS_PATH=$WORKSPACE_PATH/scripts/imaging/advanced/slam/no_lens_light
export NOTEBOOKS_PATH=$WORKSPACE_PATH/notebooks/imaging/advanced/slam/no_lens_light
