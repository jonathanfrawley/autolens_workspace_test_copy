...
export SCRIPTS_PATH=$WORKSPACE_PATH/scripts/imaging/simulators/instruments
export NOTEBOOKS_PATH=$WORKSPACE_PATH/notebooks/imaging/simulators/instruments
...
git add -f $WORKSPACE_PATH/dataset/imaging/instruments/*