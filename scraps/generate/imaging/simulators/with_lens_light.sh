...
export SCRIPTS_PATH=$WORKSPACE_PATH/scripts/imaging/simulators/with_lens_light
export NOTEBOOKS_PATH=$WORKSPACE_PATH/notebooks/imaging/simulators/with_lens_light
...
git add -f $WORKSPACE_PATH/dataset/imaging/with_lens_light