...
export SCRIPTS_PATH=$WORKSPACE_PATH/scripts/imaging/simulators/no_lens_light
export NOTEBOOKS_PATH=$WORKSPACE_PATH/notebooks/imaging/simulators/no_lens_light
...
git add -f $WORKSPACE_PATH/dataset/imaging/no_lens_light