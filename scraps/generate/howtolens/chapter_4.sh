...
export SCRIPTS_PATH=$WORKSPACE_PATH/scripts/howtolens/chapter_4_inversions
export NOTEBOOKS_PATH=$WORKSPACE_PATH/notebooks/howtolens/chapter_4_inversions
