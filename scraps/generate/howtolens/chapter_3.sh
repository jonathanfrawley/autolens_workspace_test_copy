...
export SCRIPTS_PATH=$WORKSPACE_PATH/scripts/howtolens/chapter_3_pipelines
export NOTEBOOKS_PATH=$WORKSPACE_PATH/notebooks/howtolens/chapter_3_pipelines
...
rm $NOTEBOOKS_PATH/pipelines/*.ipynb
