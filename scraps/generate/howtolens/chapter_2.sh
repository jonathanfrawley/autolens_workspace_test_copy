...
export SCRIPTS_PATH=$WORKSPACE_PATH/scripts/howtolens/chapter_2_lens_modeling
export NOTEBOOKS_PATH=$WORKSPACE_PATH/notebooks/howtolens/chapter_2_lens_modeling
...
cp $SCRIPTS_PATH/introduction $NOTEBOOKS_PATH
cp $SCRIPTS_PATH/tutorial_10_summary $NOTEBOOKS_PATH
git add $NOTEBOOKS_PATH/*.ipynb
git add $NOTEBOOKS_PATH/introduction
git add $NOTEBOOKS_PATH/tutorial_10_summary
