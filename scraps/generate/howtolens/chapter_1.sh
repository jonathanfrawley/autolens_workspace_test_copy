...
export SCRIPTS_PATH=$WORKSPACE_PATH/scripts/howtolens/chapter_1_introduction
export NOTEBOOKS_PATH=$WORKSPACE_PATH/notebooks/howtolens/chapter_1_introduction
