...
export SCRIPTS_PATH=$WORKSPACE_PATH/scripts/point_source/simulators
export NOTEBOOKS_PATH=$WORKSPACE_PATH/notebooks/point_source/simulators
...
git add -f $WORKSPACE_PATH/dataset/point_source