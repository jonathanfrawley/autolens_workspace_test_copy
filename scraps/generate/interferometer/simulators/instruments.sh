...
export SCRIPTS_PATH=$WORKSPACE_PATH/scripts/interferometer/simulators/instruments
export NOTEBOOKS_PATH=$WORKSPACE_PATH/notebooks/interferometer/simulators/instruments
...
git add -f $WORKSPACE_PATH/dataset/interferometer/instruments/*