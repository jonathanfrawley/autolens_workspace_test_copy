...
export SCRIPTS_PATH=$WORKSPACE_PATH/scripts/interferometer/simulators
export NOTEBOOKS_PATH=$WORKSPACE_PATH/notebooks/interferometer/simulators
...
git add -f $WORKSPACE_PATH/dataset/interferometer
git add -f $WORKSPACE_PATH/dataset/interferometer/*
git add -f $WORKSPACE_PATH/dataset/interferometer/*/*