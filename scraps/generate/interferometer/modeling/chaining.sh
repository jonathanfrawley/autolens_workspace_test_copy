...
export SCRIPTS_PATH=$WORKSPACE_PATH/scripts/interferometer/modeling/chaining
export NOTEBOOKS_PATH=$WORKSPACE_PATH/notebooks/interferometer/modeling/chaining
