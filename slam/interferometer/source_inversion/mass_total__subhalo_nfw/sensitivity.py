...
setup_subhalo = al.SetupSubhalo(
    source_is_model=True, number_of_steps=2, number_of_cores=2
)
...
from slam.interferometer.pipelines import source__inversion
from slam.interferometer.pipelines import mass__total
from slam.interferometer.pipelines import subhalo
