...
"""
path_prefix = path.join("imaging", "slam", "mass_total__source_parametric", "hyper_all")
...
The SOURCE PARAMETRIC PIPELINE uses one search to initialize a robust model for the source galaxy's light. 
 
In this runner the SOURCE PIPELINE: 
