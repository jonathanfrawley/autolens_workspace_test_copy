...
These settings are used and described throughout the `autolens_workspace/notebooks/modeling` example scripts, with a 
complete description of all settings given in `autolens_workspace/notebooks/modeling/customize/settings.py`.
...
"""
NOTE: The `mass_prior_model` does not get used now.
"""
...
mass_0 = af.PriorModel(al.mp.EllipticalIsothermal)
mass_1 = af.PriorModel(al.mp.EllipticalIsothermal)
mass_2 = None
mass_3 = None

# You can edit these as follows if you need...

# mass_0.centre = mass_1.centre

mass__total = mass__total.make_pipeline(
    slam=slam, settings=settings, source_results=source_results, mass_0=mass_0, mass_1=mass_1, mass_2=mass_2, mass_3=mass_3
)
